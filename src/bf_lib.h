...
gchar *gdk_color_to_rgbstring(GdkColor * color);
gchar *gdk_color_to_hexstring(GdkColor * color);
gchar *gdk_color_to_hslstring(GdkColor * color);

gboolean hsl_to_rgb(guint8 hue, guint8 sat, guint8 lum, guint8 *red, guint8 *green, guint8 *blue);
gboolean parse_colorstring_8bit(const gchar *colorstring, guint8 *red, guint8 *green, guint8 *blue);
