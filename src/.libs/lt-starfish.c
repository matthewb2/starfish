...
/* ./.libs/lt-starfish.c - temporary wrapper executable for .libs/starfish.exe
   Generated by libtool (GNU libtool) 2.5.4

   The starfish program cannot be directly executed until all the libtool
...
const char * EXE_PATH_VALUE   = "D:\\msys64_250221\\mingw64\\lib:D:\\msys64_250221\\mingw64\\bin;";
const char * TARGET_PROGRAM_NAME = "starfish.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# starfish - temporary wrapper script for .libs/starfish.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.5.4\n", f);
  fputs ("#\n", f);
  fputs ("# The starfish program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"starfish.exe:starfish:$LINENO: libtool wrapper (GNU libtool) 2.5.4\" 1", f);
  fputs (">&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"starfish.exe:starfish:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"starfish.exe:starfish:$LINENO: newargv[0]: $progdir\\\\$program\" 1", f);
  fputs (">&2\n", f);
  ...
  fputs ("    PATH=D:/msys64_250221/mingw64/lib:D:/msys64_250221/mingw64/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    if test \"$libtool_execute_magic\" != \"%%%MAGIC variable%%%\"; then\n", f);
